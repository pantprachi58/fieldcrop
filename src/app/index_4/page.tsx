    ...
    <>
			...
			<div
				...
				<div className="start-screen__slide">
					<div className="start-screen__bg" style={{"backgroundImage":"url(img/home_img/img_7.jpg)","backgroundPosition":"top 30% right 30%"}}></div>

					<div className="start-screen__content__item align-items-center">
						<div className="container">
							<div className="row">
								<div className="col-12 col-sm-10 col-md-9 col-lg-9 col-xl-8">
									<h2 className="__title"><span>Get the</span> Fresh Food <span>from our</span> FieldCrop Market</h2>

									<p>
										<span className="d-none d-sm-block"><a className="custom-btn custom-btn--big custom-btn--style-1" href="#">Discover</a></span>
										<span className="d-block d-sm-none"><a className="custom-btn custom-btn--small custom-btn--style-1" href="#">Discover</a></span>
									</p>
								</div>
							</div>
						</div>
				...
				<div className="start-screen__slide">
					<div className="start-screen__bg" style={{"backgroundImage":"url(img/home_img/img_8.jpg)","backgroundPosition":"top 30% left 70%"}}></div>

					<div className="start-screen__content__item align-items-center">
						<div className="container">
							<div className="row justify-content-end">
								<div className="col-12 col-sm-10 col-md-9 col-lg-8 col-xl-7">
									<h2 className="__title"><span>Awesome</span> Organic Cosmetic <span>from FieldCrop</span></h2>
									...
									<p className="mt-5 mt-md-8">
										<span className="d-none d-sm-block"><a className="custom-btn custom-btn--big custom-btn--style-2" href="#">Discover</a></span>
										<span className="d-block d-sm-none"><a className="custom-btn custom-btn--small custom-btn--style-2" href="#">Discover</a></span>
									</p>
								</div>
							</div>
						</div>
				...
				<div className="start-screen__slide">
					<div className="start-screen__bg" style={{"backgroundImage":"url(img/home_img/img_9.jpg)"}}></div>

					<div className="start-screen__content__item align-items-center">
						<div className="container">
							<div className="row justify-content-center text-center">
								<div className="col-12 col-md-9 col-lg-8 col-xl-7">
									<h2 className="__title text-white"><span>Fresh</span> Blueberries & Citrus <span>from FieldCrop</span></h2>
			...
			<main role="main">
				...
				<section className="section section--no-pt section--no-pb">
					<div className="container-fluid">
							...
							<div className="__inner">
								<div className="row">
									<div className="col-12 col-md-6 col-lg-4">
										<a className="__item" href="#"><img src="/img/promo-banners_img/1.jpg" alt="demo" className="img-fluid w-100" /></a>
									</div>

									<div className="col-12 col-md-6 col-lg-4">
										<a className="__item" href="#"><img src="/img/promo-banners_img/2.jpg" alt="demo" className="img-fluid w-100" /></a>
									</div>

									<div className="col-12 col-md-6 col-lg-4">
										<a className="__item" href="#"><img src="/img/promo-banners_img/3.jpg" alt="demo" className="img-fluid w-100" /></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="spacer py-4 py-lg-6"></div>
					</div>
				</section>
				...
				<section className="section">
					...
					<div className="container">
						<div className="section-heading section-heading--left" data-aos="fade">
							<h2 className="__title">Featured <span>Products</span></h2>
						</div>
				...
				<section className="section">
					<div className="d-none d-lg-block">
						<img id="bg-img-1" className="img-fluid" src="/img/FieldCrop_2.png" alt="demo" />
					...
					<div className="container">
						<div className="row">
							<div className="col-12 col-md-5 col-lg-4">
								<div className="section-heading section-heading--left" data-aos="fade">
									<p>
										<img className="img-fluid " src="/img/logo_small.png" width="50" height="50" alt="demo" />
									</p>

									<h2 className="__title">Fruits & vegetables <span>farm products</span></h2>

									<p><a className="custom-btn custom-btn--medium custom-btn--style-1" href="#">More about</a></p>
								</div>
							</div>
										...
										<div className="row">
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="100" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/7.png" alt="demo" />
													</i>

													<h5 className="__title">Blueberry</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="200" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/8.png" alt="demo" />
													</i>

													<h5 className="__title">Strawberry</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="300" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/9.png" alt="demo" />
													</i>

													<h5 className="__title">Apples</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="400" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/10.png" alt="demo" />
													</i>

													<h5 className="__title">Orange</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="500" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/11.png" alt="demo" />
													</i>

													<h5 className="__title">Carrot</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="600" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/12.png" alt="demo" />
													</i>

													<h5 className="__title">Cabbage</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="700" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/13.png" alt="demo" />
													</i>

													<h5 className="__title">Potato</h5>
												</div>
											</div>
											...
											<div className="col-6 col-sm-4 col-lg-3">
												<div className="__item  text-center" data-aos="fade" data-aos-delay="800" data-aos-offset="100">
													<i className="__ico">
														<img className="img-fluid " src="/img/feature_img/14.png" alt="demo" />
													</i>

													<h5 className="__title">Eggplant</h5>
												</div>
											</div>
				...
				<section className="section section--no-pt">
					<div className="container">
						<div className="special-offer special-offer--style-2" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="70">
				...
				<section className="section section--no-pt">
					<div className="container">
						<div className="section-heading section-heading--center" data-aos="fade">
							<h2 className="__title">Bestseller <span>Products</span></h2>
											...
											<div className="row">
												...
												<div className="col-12 col-md-6">
													<div className="__content">
														...
														<div className="product-price">
															<span className="product-price__item product-price__item--new">6.68 $</span>
															<span className="product-price__item product-price__item--old">8.11 $</span>
														</div>
									...
									<div className="col-12 col-sm-6 col-lg-5 col-xl-4">
										<div className="__item">
											<div className="row">
												...
												<div className="col-12 col-md-6">
													<div className="__content">
														<h4 className="h6 __title"><a href="/single_product">Fresh Orange</a></h4>
														...
														<div className="product-price">
															<span className="product-price__item product-price__item--new">3.55 $</span>
														</div>
											...
											<div className="row">
												...
												<div className="col-12 col-md-6">
													<div className="__content">
														...
														<div className="product-price">
															<span className="product-price__item product-price__item--new">7.63 $</span>
														</div>
									...
									<div className="col-12 col-sm-6 col-lg-5 col-xl-4">
										<div className="__item">
											<div className="row">
												...
												<div className="col-12 col-md-6">
													<div className="__content">
														<h4 className="h6 __title"><a href="/single_product">Tasty Strawberry</a></h4>
														...
														<div className="product-price">
															<span className="product-price__item product-price__item--new">3.12 $</span>
														</div>
									...
									<div className="col-12 col-sm-6 col-lg-5 col-xl-4">
										<div className="__item">
											<div className="row">
												<div className="col-12 col-md-6">
													<figure className="__image">
														<img className="" width="140" src="/img/goods_img/5.jpg" alt="demo" />
													</figure>
												</div>
									...
									<div className="col-12 col-sm-6 col-lg-5 col-xl-4">
										<div className="__item">
											<div className="row">
												<div className="col-12 col-md-6">
													<figure className="__image">
														<img className="" width="160" src="/img/goods_img/8.jpg" alt="demo" />
													</figure>
												</div>
						...
						<div className="spacer py-6 py-md-10"></div>

						
						<div className="goods goods--style-3">
							<div className="__inner">
								<div className="row">
									...
									<div className="col-12 col-sm-6 col-lg-3">
										<div className="__item">
											<figure className="__image">
												<img className="" src="/img/goods_img/1_1.jpg" alt="demo" />
											</figure>

											<div className="__content">
												<h4 className="h6 __title"><a href="/single_product">Organic Raspberries</a></h4>
									...
									<div className="col-12 col-sm-6 col-lg-3">
										<div className="__item">
											<figure className="__image">
												<img className="" src="/img/goods_img/1_2.jpg" alt="demo" />
											</figure>
									...
									<div className="col-12 col-sm-6 col-lg-3">
										<div className="__item">
											<figure className="__image">
												<img className="" src="/img/goods_img/1_3.jpg" alt="demo" />
											</figure>

											<div className="__content">
												<h4 className="h6 __title"><a href="/single_product">Organic Blackberry</a></h4>
									...
									<div className="col-12 col-sm-6 col-lg-3">
										<div className="__item">
											<figure className="__image">
												<img className="" src="/img/goods_img/1_4.jpg" alt="demo" />
											</figure>

											<div className="__content">
												<h4 className="h6 __title"><a href="/single_product">Awesome Strawberry</a></h4>
												...
												<div className="product-price">
													<span className="product-price__item product-price__item--new">1.12 $</span>
												</div>
										...
										<div className="row">
											<div className="col-12 col-lg-7 col-xl-6">
												<div className="banner__text" data-aos="fade-left" data-delay="500">
													<h2 className="__title h1"><b style={{"display":"block","color":"#c6c820"}}>Fresh Exotic Fruits</b> <span>in Our Store</span></h2>
