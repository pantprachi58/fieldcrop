export default function BlogDetails() {
  return (
    <>
			...
			<div id="hero" className="jarallax" data-speed="0.7" data-img-position="50% 30%" style={{"backgroundImage":"url(img/intro_img/5.jpg)"}}>
				<div className="container">
					<div className="row">
						<div className="col-12 col-lg-7">
							<h1 className="__title"><span>Our</span> Blog</h1>
								...
								<div className="content-container">
									...
									<div className="posts">
										...
										<div className="__item">
											<img className="" width="100%" src="/img/posts_img/4.jpg" alt="demo" />
											...
											<div className="__content">
												...
												<p>
													We believe in helping brands create <a href="#">through strategy</a>, story-telling, digital products, and integrated experiences on web, mobile, and in the world. And you're here, friends, because you also believe.
												</p>
													...
													<td>
														<div className="d-none d-lg-block">
															...
															<div className="comment__author-img">
																<img className="img-fluid" width="70" src="/img/avatar.jpg" alt="demo" />
															</div>
												...
												<tr>
													...
													<td>
														...
														<div className="text-right">
															<a className="comment__reply custom-btn custom-btn--tiny custom-btn--style-1" href="#">REPLY</a>
														</div>
													</td>
												</tr>
											</table>
										...
										<div className="row align-items-center justify-content-between">
											...
											<div className="col-12 col-md-auto mb-6">
												<div className="share-btns">
													<ul>
														<li><a className="fb" href="#"><i className="fontello-facebook"></i>facebook</a></li>
														<li><a className="tw" href="#"><i className="fontello-twitter"></i>twitter</a></li>
														<li><a className="ggl" href="#"><i className="fontello-gplus"></i>google plus</a></li>
														<li><a className="pt" href="#"><i className="fontello-pinterest-circled"></i>pinterest</a></li>
													</ul>
												</div>
											</div>
										</div>
										...
										<div className="row">
											<div className="col-12 col-sm-6">
												<div className="input-wrp">
													<input className="textfield" type="text" value="" placeholder="Name" />
												</div>
											</div>

											<div className="col-12 col-sm-6">
												<div className="input-wrp">
													<input className="textfield" type="text" value="" placeholder="E-mail" />
												</div>
											</div>
										</div>

										<div className="input-wrp">
											<textarea className="textfield" placeholder="Comments"></textarea>
										</div>

										<button className="custom-btn custom-btn--medium custom-btn--style-1" type="submit" role="button">post comment</button>
									</form>
								</div>
								
							</div>

							<div className="col-12 my-6 d-md-none"></div>
							...
							<div className="col-12 col-md-4 col-lg-3">
								<aside className="sidebar">
										...
										<div>
											<article>
												<a className="link" href="#">
													<img className="" width="100" height="75" src="/img/posts_img/1s.jpg" alt="demo" />
												</a>
											...
											<article>
												<a className="link" href="#">
													<img className="" width="100" height="75" src="/img/posts_img/2s.jpg" alt="demo" />
												</a>
									...
									<div className="widget widget--banner">
										<a href="#"><img className="img-fluid " src="/img/widget_banner.jpg" alt="demo" /></a>
									</div>
							...
							<li className="post-nav__item">
								<a className="post-nav__link post-nav__link--prev" href="#">
									<span className="d-table">
										<span className="d-table-cell align-middle"><i className="ico fontello-left-1"></i></span>
							...
							<li className="post-nav__item">
								<a className="post-nav__link post-nav__link--next" href="#">
									<span className="d-table">
										...
										<span className="d-table-cell align-middle"><i className="ico fontello-right-1"></i></span>
									</span>
								</a>
							</li>
						</ul>
